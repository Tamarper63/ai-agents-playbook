...
| Policy enforcement in prompt assembly (authority/provenance separation) | {% include page-title-link.html url="/articles/agent-security/prompt-assembly-policy-enforcement/" fallback="Prompt assembly policy enforcement" %} | {% include page-title-link.html url="/articles/agent-security/request-assembly-threat-model/" fallback="Request assembly threat model" %} |
