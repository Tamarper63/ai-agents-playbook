...
- **Information-oriented** (not step-by-step procedures).
- **Consistent and predictable** in structure and headings (optimize scan + lookup).
- **Linkable anchors** (each page stands alone as a canonical citation target).

## Related

- [Policies]({{ '/policies/' | relative_url }}) — normative constraints and enforcement rules.
- [Prompt library]({{ '/prompts/' | relative_url }}) — copy/paste prompt assets for controlled AI work.
